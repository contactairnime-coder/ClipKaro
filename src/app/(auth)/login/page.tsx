  ...
  return (
    <AuthLayout variant="login">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-2 mb-8">Apne account mein login karo</p>
          ...
          <AnimatePresence>
            {error && (
              <motion.p
                ...
                exit={{ opacity: 0 }}
                className={`text-sm text-red-500 bg-red-50 dark:bg-red-900/20 px-4 py-2 rounded-lg ${shake ? "animate-shake" : ""}`}
              >
                {error}
              </motion.p>
            )}
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white dark:bg-[#0a0a0a] px-3 text-gray-400">OR CONTINUE WITH</span>
          </div>
        </div>
